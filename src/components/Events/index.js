...
class Events extends Component {
  state = {activeEvent: 'default'}

  selectedItemDetails = id => {
    const {registrationStatus} = eventsList.find(eachItem => eachItem.id === id)
  ...
  render() {
    ...
    return (
      <div className="bg">
        ...
        <div className="activeElementBg">
          <ActiveEventRegistrationDetails status={activeEvent} />
        </div>
      </div>
    )
  }
